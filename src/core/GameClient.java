...
//                short requestLength = DataReader.readShort(dataInputStream);
                short requestLength = dataInputStream.readShort();
...
//                    requestCode = DataReader.readShort(dataInput);
                    requestCode = dataInput.readShort();
                    ...
                    {
                        if (requestCode == Constants.CMSG_LOG_OFF)
                            isDone =true;
                    }
                } else {
        ...
        GameServer.getInstance().cleanUp();
    }
    ...
    public void removePlayerData() {
        ...
        Log.printf("User '%s' has logged off.", player.getID());
    }
    ...
    /**
     * @param newTestVar the newTestVar to set
     */
