...
public class GameRequestTable {
    ...
    public static void init() {
        ...
        add(Constants.CMSG_ENEMIES, "RequestEnemies");
        add(Constants.CMSG_HEARTBEAT, "RequestHeartbeat");
        add(Constants.CMSG_PLATERUPDATE, "RequestPlayerUpdate");
        add(Constants.CMSG_ADD_BULLET, "RequestAddBullet");
        add(Constants.CMSG_UPDATE_BULLET, "RequestUpdateBullet");
        add(Constants.CMSG_UI_INFO_UPDATE, "RequestUpdateUiInfo");
        add(Constants.CMSG_ADD_POWER_UP, "RequestAddPowerUp");
        add(Constants.CMSG_LOG_OFF, "RequestLogOff");
    }
